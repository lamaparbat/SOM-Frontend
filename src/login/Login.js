  ...
  return (
    <>
      <div className="main_container">
        <div className="form">
          <h5 className="font-monospace"><strong><ArrowBack id="arrowback" style={{ marginTop: "-5px", marginLeft: "-5px" }} onClick={redirect} /> SIGNUP INTO TED_STORIES</strong></h5><br />
